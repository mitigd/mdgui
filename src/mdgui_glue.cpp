...
void apply_theme_builtin(int theme_id) {
  ...
  case MDGUI_THEME_DARK:
    ...
    set_theme_slot(247, 0x5d, 0x8b, 0xff, 0xff); // CLR_ACCENT
    set_theme_slot(248, 0x5d, 0x8b, 0xff, 0xff); // CLR_WINDOW_BORDER
    break;
  case MDGUI_THEME_AMBER:
    ...
    set_theme_slot(247, 0xbc, 0x8a, 0x2f, 0xff); // CLR_ACCENT
    set_theme_slot(248, 0xbc, 0x8a, 0x2f, 0xff); // CLR_WINDOW_BORDER
    break;
  case MDGUI_THEME_GRAPHITE:
    ...
    set_theme_slot(247, 0x66, 0x8a, 0xc4, 0xff); // CLR_ACCENT
    set_theme_slot(248, 0x66, 0x8a, 0xc4, 0xff); // CLR_WINDOW_BORDER
    break;
  case MDGUI_THEME_MIDNIGHT:
    ...
    set_theme_slot(247, 0x4b, 0x90, 0xff, 0xff); // CLR_ACCENT
    set_theme_slot(248, 0x4b, 0x90, 0xff, 0xff); // CLR_WINDOW_BORDER
    break;
  case MDGUI_THEME_OLIVE:
    ...
    set_theme_slot(247, 0x7d, 0x9a, 0x57, 0xff); // CLR_ACCENT
    set_theme_slot(248, 0x7d, 0x9a, 0x57, 0xff); // CLR_WINDOW_BORDER
    break;
